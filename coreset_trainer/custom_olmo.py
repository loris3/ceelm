...
from transformers.models.olmo2.modular_olmo2 import Olmo2RotaryEmbedding
class DecomposedOlmo2():
    """
    Olmo2 that uses the decomposed layer processing
    """
    ...
    def forward_final_layer(
        ...
        position_embeddings = intermediate_outputs['position_embeddings']
